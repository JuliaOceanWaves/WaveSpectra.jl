...
struct Spectrum{TDAT, TAX1, TAX2}  <: AbstractMatrix{TDAT}
    ...
    function Spectrum(data::AbstractMatrix{<:Quantity}, axis1::AbstractVector{<:Quantity}, axis2::AbstractVector{<:Quantity})
        ...
        typeaxis2 = axistype(axistype(axis2))[1][1]
...
# axisnames
axistype(S::Spectrum) = (axistype(S.axis1), axistype(S.axis2))
axistype(S::OmniSpectrum) = axistype(S.axis)
...
# Base.dotview(s::Spectrum; kwargs...) = Base.dotview(s.data)
