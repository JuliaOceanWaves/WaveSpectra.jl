module WaveSpectraPlotsExt

using Plots: @recipe, mm
using Unitful: uconvert, unit, ustrip
using WaveSpectra: AbstractOmnidirectionalSpectrum, AbstractSpectrum, axesnames,
                   _prepend_zero_axis, _prepend_zero_data, rad
